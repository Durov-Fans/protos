...
func (c *creatorServiceClient) BuySub(ctx context.Context, in *BuySubRequest, opts ...grpc.CallOption) (*BuySubResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BuySubResponse)
	err := c.cc.Invoke(ctx, CreatorService_BuySub_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CreatorService_GetTierPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(CreatorServiceServer).GetTierPrice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _CreatorService_BuySub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BuySubRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CreatorServiceServer).BuySub(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CreatorService_BuySub_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CreatorServiceServer).BuySub(ctx, req.(*BuySubRequest))
	}
	return interceptor(ctx, in, info, handler)
}
